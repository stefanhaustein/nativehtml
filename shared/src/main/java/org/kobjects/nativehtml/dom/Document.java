...
public class Document {
    ...
    static {
        ELEMENT_TYPES.put("a", ElementType.TEXT);
        ELEMENT_TYPES.put("b", ElementType.TEXT);
        ELEMENT_TYPES.put("big", ElementType.TEXT);
        ELEMENT_TYPES.put("br", ElementType.TEXT);
        ELEMENT_TYPES.put("del", ElementType.TEXT);
        ELEMENT_TYPES.put("em", ElementType.TEXT);
        ELEMENT_TYPES.put("font", ElementType.TEXT);
        ELEMENT_TYPES.put("head", ElementType.ELEMENT_DATA);
        ELEMENT_TYPES.put("html", ElementType.SKIP);
        ELEMENT_TYPES.put("i", ElementType.TEXT);
        ...
        ELEMENT_TYPES.put("ins", ElementType.TEXT);
        ...
        ELEMENT_TYPES.put("small", ElementType.TEXT);
        ELEMENT_TYPES.put("span", ElementType.TEXT);
        ELEMENT_TYPES.put("strike", ElementType.TEXT);
        ELEMENT_TYPES.put("strong", ElementType.TEXT);
        ELEMENT_TYPES.put("style", ElementType.TEXT_DATA);
        ELEMENT_TYPES.put("sub", ElementType.TEXT);
        ELEMENT_TYPES.put("sup", ElementType.TEXT);
        ...
        ELEMENT_TYPES.put("tt", ElementType.TEXT);
